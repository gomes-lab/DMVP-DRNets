...
tf.app.flags.DEFINE_string('model_dir', './data/small_model/','path to store the checkpoints of the model')
...
tf.app.flags.DEFINE_string('data_dir', '../data/loc_100sp_nlcd2011.npy','The path of input observation data')
...
tf.app.flags.DEFINE_integer('batch_size', 512, 'the number of data points in one minibatch') #128
tf.app.flags.DEFINE_integer('testing_size', 512, 'the number of data points in one testing or validation batch') #128
tf.app.flags.DEFINE_integer('mon', 5, 'the number of data points in one testing or validation batch') #128
tf.app.flags.DEFINE_integer('case', 301, 'the number of data points in one testing or validation batch') #128
...
tf.app.flags.DEFINE_integer('r_dim', 500, 'the number of labels in current training') #100
tf.app.flags.DEFINE_integer('r_max_dim', 500, 'max number of all labels in the dataset')

tf.app.flags.DEFINE_integer('loc_offset', 2, 'the offset caused by location features') #100
tf.app.flags.DEFINE_integer('nlcd_dim', 72, 'the dimensionality of the NLCD features ')
