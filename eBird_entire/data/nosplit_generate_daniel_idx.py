...
for ii in range(1):
    for jj in range(1, 13):
        a = np.load("./small_region/daniel_bird_%d.npy" % (jj))
        num = a.shape[0]
        ...
        np.save("./small_region/daniel_bird_train_idx_%d.npy" % (jj), train_idx)
        np.save("./small_region/daniel_bird_val_idx_%d.npy" % (jj), val_idx)
        np.save("./small_region/daniel_bird_test_idx_%d.npy" % (jj), test_idx)
