...
tf.app.flags.DEFINE_integer('batch_size', 60, 'the number of data points in one minibatch') #128
tf.app.flags.DEFINE_integer('testing_size', 60, 'the number of data points in one testing or validation batch') #128
tf.app.flags.DEFINE_float('learning_rate', 0.001, 'initial learning rate')
#tf.app.flags.DEFINE_float('pred_lr', 1, 'the learning rate for predictor')
tf.app.flags.DEFINE_integer('max_epoch', 20, 'max epoch to train')
